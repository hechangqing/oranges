...
OBJS		= kernel/kernel.o kernel/start.o kernel/main.o\
			  kernel/i8259.o kernel/clock.o kernel/global.o kernel/protect.o\
			  lib/klib.o lib/kliba.o lib/string.o kernel/proc.o kernel/syscall.o
...
# We assume that bochs config file "bochsrc_hcq" exists in current folder
run:
	bochs -f bochsrc_hcq
...
kernel/clock.o : kernel/clock.c include/type.h include/const.h include/protect.h include/proc.h include/proto.h\
					include/global.h
	$(CC) $(CFLAGS) -o $@ $<

kernel/proc.o : kernel/proc.c include/type.h include/const.h include/protect.h include/proc.h include/proto.h\
					include/global.h
	$(CC) $(CFLAGS) -o $@ $<
